...
Run = dodge.data_class("Run", [
    ...
    "is_underline", "is_strike", "vertical_alignment",
])
...
def run(children, style_id=None, style_name=None, is_bold=None, is_italic=None, is_underline=None, is_strike=None, vertical_alignment=None):
    if vertical_alignment is None:
        vertical_alignment = VerticalAlignment.baseline
    return Run(
        children, style_id, style_name, bool(is_bold), bool(is_italic),
        bool(is_underline), bool(is_strike), vertical_alignment,
    )
